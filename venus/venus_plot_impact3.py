...
for mode in ['theta', 'r']:
    ...
    if mode == 'r':
        ax_joint.set_xlim(1.,2.0)
        ax_marg_x.set_xlim(1.,2.0)
        ...
        ax_marg_y.set_xlim(0,150)
        ax_marg_y.xaxis.set_major_locator(MultipleLocator(150))
        ax_marg_y.xaxis.set_minor_locator(MultipleLocator(50))

        ax_marg_x.yaxis.set_major_locator(MultipleLocator(500))
    ...
    fig.savefig('impact'+mode+'.pdf',transparent=True,bbox_inches='tight')
    # fig.savefig('impact'+mode+'.png',transparent=True,bbox_inches='tight',dpi=300)
    # #fig.savefig('figs10'+mode+'.eps',transparent=False,bbox_inches='tight')
    # fig.savefig('impact'+mode+'scatter.tiff',dpi=600,transparent=True,bbox_inches='tight')