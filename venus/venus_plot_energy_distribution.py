...
fig2, ax2 = plt.subplots(max_state,1, sharex='all',sharey='all')
...
fig2.set_figheight(max_state+2)
fig2.set_figwidth(4)
fig2.text(0.5, 0.03, "Component", ha='center',fontsize=15)
fig2.text(0.01, 0.5, r'E$_f$ - E$_i$ / eV', va='center', rotation='vertical',fontsize=15)
