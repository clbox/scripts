...
for b,basis in enumerate([24,48,64]):
    ...
    for i in range(dimension):
            ...
            for j in range(dimension):
                ...
                if i == 2 and j == 2:
                    ...
                    ax.plot(x,y,label=r'$N_k={}$'.format(basis),marker=markers[b],color=colours[b],linestyle='none',
...
ax.legend(fancybox=True,framealpha=1,edgecolor='black')
