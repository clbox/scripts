...
for mode in ['theta', 'r']:
    ...
    for i,v in enumerate([-1,2]):
        ...
        if mode == 'r':
            ...
            #ax_joint.scatter(r,centre_mass_z,zorder=zorder,label=label,marker=markers[i], **marker_args[i],edgecolors=colours[i])
            ...
            N_trajs_theta.append(len(angle))
            #ax_joint.scatter(angle,centre_mass_z,zorder=zorder,label=label,marker=markers[i], **marker_args[i],edgecolors=colours[i])
    ...
    ax_joint.annotate(r'$v_i = 2$',ha="left", **annotate_args)
    ...
    if mode == 'r':
        ...
        ax_marg_y.xaxis.set_major_locator(MultipleLocator(60))
        ax_marg_y.xaxis.set_minor_locator(MultipleLocator(20))
        ax_marg_x.set_ylim(0,220)
        ax_marg_x.yaxis.set_major_locator(MultipleLocator(220))
        ax_marg_x.yaxis.set_minor_locator(MultipleLocator(20))
        ax_marg_y.set_ylim(1.25,3)
        ax_joint.set_ylim(1.25,3)
        ax_joint.set_ylabel(r"COM height / $\mathrm{\AA{}}$")
        ax_joint.text(1.2, 1.5, "Trapped", size=12, color=blue,ha='left')
        ...
        ax_marg_x.set_ylim(0,60)
        ax_marg_y.set_xlim(0,60)
        ax_marg_y.xaxis.set_major_locator(MultipleLocator(60))
        ax_marg_y.xaxis.set_minor_locator(MultipleLocator(10))

        ax_marg_x.yaxis.set_major_locator(MultipleLocator(60))
        ax_marg_x.yaxis.set_minor_locator(MultipleLocator(10))
        ax_joint.text(0, 1.5, "Trapped", size=12, color=blue)
    ...
    fig.savefig('figs12'+mode+'.pdf',transparent=True,bbox_inches='tight')
    fig.savefig('figs12'+mode+'.png',transparent=True,bbox_inches='tight',dpi=300)
    #fig.savefig('figs12'+mode+'.eps',transparent=False,bbox_inches='tight')
    fig.savefig('figs12'+mode+'scatter.tiff',dpi=600,transparent=True,bbox_inches='tight')