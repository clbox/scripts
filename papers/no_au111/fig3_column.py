...
for initial_state in [2,3]:
    for final_state in [1,2,3]:
        ...
        ax[map_plot[c]].annotate(r'$v_i=$'+str(initial_state)+r'$\rightarrow$'+r'$v_f=$'+str(final_state),xy=(0.2,0.8),xycoords='axes fraction')
...
ax[1].set_ylabel(r'$B(v_f)$',fontname=font,color='black')
ax[2].set_ylabel(r'$B(v_f)$',fontname=font,color='black')
